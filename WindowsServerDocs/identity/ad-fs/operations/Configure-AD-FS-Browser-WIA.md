...
|Edg/79.0.309.43 | Microsoft Edge (Chromium) specific version for Windows Server 2012 R2 or earlier |
|Edg/| Microsoft Edge (Chromium) all versions for Windows Server 2012 R2 or earlier |  
